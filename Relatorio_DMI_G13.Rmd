...
Com isto, pode-se concluir que o melhor modelo foi *KNN Model* com uma *accuracy* de 69%.
Foi colocado no kaggle a sua previsão.
...
Foi possível aplicar aluns modelos de previsão e, assim, usando uma nova linguagem de programação, mais orientada a Data Science ser capaz de prever resultados finais.
Acresceu-se, ainda, a capacidade de procurar melhorar o conjunto de dados, fornecendo mais dados ao original.
Por fim, dentro do possível, completou-se a tarefa do Kaggle.
