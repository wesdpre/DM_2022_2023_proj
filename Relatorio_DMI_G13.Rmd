...
Para este trabalho foi também cedido um conjunto de dados de teste, este, será para posteriormente ser colocado o valor previsto por um modelo de machine learning que será posteriormente estudado. Contudo, este conjunto de dados apresenta alguns dados em falta como a region que apresentava dois valores nulos, estes foram preenchidos como os de dados de treino. Também se usou a função fill para preencher as colunas "extinction_date", "extinction_hour", "firstInterv_date" e "firstInterv_hour".
...
O erro de previsão RMSE (Root Mean Squared Error), este representa a diferença média entre os valores conhecidos observados nos dados de teste e os valores de resultados previstos pelo modelo. Quanto *menor* o valor, melhor o modelo.
O R-square (R2), que representa a correlação entre os valores observados e os valores previstos. Quanto *maior* o valor, melhor o modelo.
Erro absoluto médio (MAE) é o erro absoluto médio entre os valores reais e previstos. Quanto *menor* o valor, mais preciso é o modelo.
Com isto, pode-se concluir que o melhor modelo foi _KNN Model_ com uma _accuracy_ de 69%.
...
Deve concluir-se que este trabalho abordou diversas temáticas apresentadas nas aulas de Data Mining I. Apresentaram-se algumas adversidades, normais, pois o conjunto de dados teve que ser pré-processado, algumas decisões foram tomadas com intuito de melhorar o conjunto de dados mas que, por consequência, o diminui. Foi possível aplicar aluns modelos de previsão e, assim, usando uma nova linguagem de programação, mais orientada a Data Science ser capaz de prever resultados finais.
